...
systemd-nspawn --directory=${MOUNT_DIR} --machine=${pkgname}-${RANDOM} --bind=/var/cache/pacman --bind=$HOME/.gnupg:/home/build/.gnupg --bind=/var/cache/build:/home/build --bind=$(pwd):/build --network-veth $COMMAND
